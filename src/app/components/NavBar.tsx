      ...
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
            <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-cyan-500/30 rounded-full blur-[100px]" />
          ...
          <Link
            href=""
            onClick={() => setIsOpen(false)}
            className={`mt-6 px-12 py-4 bg-gradient-to-r from-white to-white text-black text-lg font-bold tracking-widest uppercase rounded-full shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all duration-500 ${
